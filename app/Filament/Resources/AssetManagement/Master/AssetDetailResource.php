...
class AssetDetailResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                getCustomTableAction(ActionType::EDIT, 'Update', 'Update Tipe Aset', Icons::EDIT, null, false, true),
                getCustomTableAction(ActionType::DELETE, null, 'Delete Tipe Aset', null, null, null, true)
            ])
            ->bulkActions([
                getCustomTableAction(ActionType::BULK_DELETE, null, null, null, null, null, true)
            ])
            ->headerActions([
                getCustomTableAction(ActionType::CREATE, 'Add', 'Tipe Aset', Icons::ADD, false, false, true)
            ])
            ->emptyStateActions([
